...
aux6= True
while aux6 == True:
  comprovacion=input("\n\n\n\nDesea hacer algun cambio en el documento?(Y/N)")
  if comprovacion == "Y" or comprovacion == "y":  
    print("\n¿Cual de las opciones desea editar?\n")
    print("1) Nombre del area: "+nombre_area+"\n")
    print("2) Nombre del servicio: "+nombre_servicio+"\n")
    print("3) Selección: "+seleccion_canales+""""\n
                Porfavor seleccione uno de los canales:\n
                1)oficinas     2)IVR \n
                3)ATM           4)POS \n
                5)Banca Por Internet \n
                """)
    print("4) Selección: "+seleccion_canales1+"""\n
                Porfavor seleccione uno de los siguientes campos:\n
                1)Incidente Tecnológico\n
                2)Proveedor Externo \n
                3)Mantenimiento \n
            """)
    print("5) Fecha de Inicio del Incidente : "+fecha_inicio+"\n")
    print("6) Hora de Inico del Incidente: "+hora_inicio+"\n")
    print("7) Fecha de Fin del Incidente: "+fecha_fin+"\n")
    print("8) Hora de Fin del Incidente: "+hora_fin+"\n")
    print("9) Descripcion: "+descripcion+descripcion1+descripcion2+"\n")
    print("10) Motivo: "+motivo+motivo1+motivo2+"\n")
    print("11) Servicios afectados: "+servicios_afectados+"\n")
    print("12) Correctivos: "+correctivos+correctivos1+correctivos2+correctivos3+correctivos4+"\n")
  ...
  elif comprovacion == "N" or comprovacion == "n":
    aux6 = False
    pass
  else :
    print("Realizo una selección invalida! porfavor intente nuevamente")
